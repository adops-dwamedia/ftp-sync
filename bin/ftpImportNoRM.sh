...
#ftp -pid ftp.platfo#rm.mediamind.com > $LOG_PATH/transfer.log 2>> $LOG_PATH/ftpErrors.log << EOF
#nlist . $TMP_PATH/oFile
#quit
#EOF


# strip out extra fo#rmatting
...
#ftp -vpi ftp.platfo#rm.mediamind.com < $TMP_PATH/downloadCmds 2>> $LOG_PATH/ftpErrors.log >> $LOG_PATH/ftpLog
#if [ "$?" -ne 0 ]
#then
